...
function registerStreamHandlers(streamAddress, addressId, outputElId, startId, stopId) {

    //  console = new Console('console', console);
    var videoOutput = document.getElementById(outputElId);
    var address = document.getElementById(addressId);
    address.value = streamAddress;
    var pipeline;
    var webRtcPeer;
    ...
    stopButton = document.getElementById(stopId);
